...
import com.f4.notification.kafka.broker.KafkaConsumer;
import com.f4.notification.kafka.handler.EventEnvelope;
...
public class MsNotificationKafkaResource {
    ...
    public MsNotificationKafkaResource(StreamBridge streamBridge, KafkaConsumer kafkaConsumer) {
